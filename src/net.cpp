...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Surajcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"surajcointools.com", "117.247.67.66"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"surajcointools.com", "testnet-seed.surajcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Surajcoin is probably already running."), addrBind.ToString().c_str());
        else
